...
**Build Command:**
Run the following command to trigger a cloud build for an installable APK (Preview profile):
...
We have exciting plans to scale this project beyond an MVP. Here is what's coming next:
  ...
  * [ ] **Home Screen Widget:** Add a native Android/iOS widget to view the word clock without opening the app.
